...
void main() async {
  ...
  try {
    ...
    debugPrint('[Megit] Firebase initialization failed or timed out: $e');
  }
  ...
  try {
    ...
    debugPrint('[Megit] Notification permission request failed or timed out: $e');
  }
  ...
  MegitAudioHandler? audioHandler;
  try {
    ...
    debugPrint('[Megit] AudioService.init failed or timed out: $e');
    audioHandler = MegitAudioHandler(AudioPlayer());
  }
