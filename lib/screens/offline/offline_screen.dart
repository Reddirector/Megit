...
/// Shows animated glowing rings around Megit logo, retry button, and go to downloads.
...
class _OfflineScreenState extends State<OfflineScreen>
  ...
  late final AnimationController _megitController;
  bool _isChecking = false;

  @override
  void initState() {
    super.initState();
    _megitController = AnimationController(
      vsync: this,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                        ...
                        children: [
                          ...
                          for (int i = 0; i < 3; i++)
                            Builder(
                              builder: (context) {
                                final offset = i / 3;
                                final progress = (_megitController.value + offset) % 1.0;
                ...
                // ── WiFi Off Icon ──
                Icon(LucideIcons.wifi_off, size: 48, color: accent),
