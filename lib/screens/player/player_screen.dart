...
class _PlayerScreenState extends ConsumerState<PlayerScreen> {
                  ...
                  child: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        icon: const Icon(LucideIcons.chevron_down, size: 28),
                      ),
                      Column(
                        children: [
                          Text('NOW PLAYING',
                      ...
                      child: _showLyrics
                          ? Consumer(
                              builder: (context, ref, _) {
                                ...
                                return _buildLyricsView(progress, accent);
                              },
                            )
                          ...
                          child: Row(
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: const Icon(LucideIcons.ellipsis_vertical,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () => ref.read(audioProvider.notifier).seekBackward(),
                              child: const Icon(LucideIcons.rotate_ccw, size: 24, color: Colors.white),
                            ),
                            GestureDetector(
                            ...
                            GestureDetector(
                              onTap: () => ref.read(audioProvider.notifier).seekForward(),
                              child: const Icon(LucideIcons.rotate_cw, size: 24, color: Colors.white),
                            ),
                            GestureDetector(
          ...
          Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(LucideIcons.music_2, size: 12, color: accent),
  ...
  // ── Lyrics view ──
  Widget _buildLyricsView(Duration progress, Color accent) {
    final activeIndex = _findActiveLineIndex(progress.inMilliseconds / 1000.0);
        ...
        child: _lyricsState == 'loading'
            ...
            : _lyricsState == 'error' || _parsedLines == null || _parsedLines!.isEmpty
                ...
                : ListView.builder(
                    ...
                    // Only the lines actually near the viewport get built —
                    // a long song's lyrics no longer get fully rebuilt and
                    // laid out on every position update.
...
class _SeekBarState extends ConsumerState<_SeekBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final bufferedFraction = audio.duration.inMilliseconds > 0
        ? (audio.bufferedProgress.inMilliseconds / audio.duration.inMilliseconds).clamp(0.0, 1.0)
        : 0.0;
              ...
              children: [
                ...
                SliderTheme(
                  data: SliderTheme.of(context).copyWith(
                    ...
                    // Make track transparent so the LinearProgressIndicator shows through correctly
