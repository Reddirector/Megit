...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  void _resetColor() {
    const defaultColor = Color(0xFF9D4EDD);
      ...
      body: SafeArea(bottom: false,
        child: ListView(
          ...
          children: [
            ...
            // ── Streaming Quality ──
            _sectionTitle(LucideIcons.volume_2, 'Streaming Quality'),
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: const Icon(LucideIcons.audio_waveform,
