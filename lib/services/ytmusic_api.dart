...
class YtMusicApi {
  ...
  Future<List<Playlist>> getLibraryPlaylists(String accessToken) async {
    final payload = _buildContext();
    payload['browseId'] = 'FEmusic_library_playlists';
    final data = await _post('browse', payload, accessToken: accessToken);
    return YtMusicParser.parseLibraryPlaylists(data);
  }
