      ...
      child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            // ── Actions ──
            _ActionItem(
              icon: LucideIcons.list_music, label: 'Add to Queue',
              onTap: () {
            ...
            _ActionItem(
              icon: LucideIcons.play, label: 'Start Mix',
              onTap: () {
                ref.read(audioProvider.notifier).startRadio(widget.song);
                Navigator.pop(context);
              },
            ),
            _ActionItem(
              icon: LucideIcons.square_plus, label: 'Add to Playlist',
              onTap: () {
                Navigator.pop(context);
            ...
            if (widget.showRemove) ...[
              const Divider(height: 16, indent: 20, endIndent: 20),
              _ActionItem(
                icon: LucideIcons.trash_2, label: 'Remove from Playlist',
                danger: true,
                onTap: () {
            ...
            if (widget.showRemoveDownload) ...[
              ...
              _ActionItem(
                icon: LucideIcons.trash_2, label: widget.removeDownloadLabel ?? 'Remove from Downloads',
                danger: true,
                onTap: () {
